...
namespace CRMCleaner.Classes
{
    class LogFileHelper
    {
        ...
        {
            string[] strarr = null;
            string FolderPath = ConfigurationSettings.AppSettings["POSTLogFileLoc"].ToString();
            ...
            {
                FILE_NAME = ConfigurationSettings.AppSettings["POSTLogFileLoc"].ToString() + ModeSync + DateTime.Now.ToString("dd-MMM-yyyy") + ".txt";
            }
            else
            {
                ...
                if (LastCounter == 0)
                    ...
                    FILE_NAME = ConfigurationSettings.AppSettings["POSTLogFileLoc"].ToString() + ModeSync + DateTime.Now.ToString("dd-MMM-yyyy") + "_" + LastCounter.ToString() + ".txt";
